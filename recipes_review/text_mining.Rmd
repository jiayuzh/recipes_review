...
```
```{r}
review_100_orig = read.csv("/Users/Sherry_Se7en/Downloads/food-com-recipes-and-user-interactions/RAW_interactions_100.csv", stringsAsFactors = F)
review_100 = review_100_orig %>% select(user_id, recipe_id, rating, review)
mycolors = c("#E69F00", "#56B4E9", "#009E73", "#CC79A7", "#D55E00")
```
...
```
```{r}
review_100$review = sapply(review_100$review, fix_contractions)

remove_spec_char = function(x) gsub("[^a-zA-Z0-9 ]", " ", x)
review_100$review = sapply(review_100$review, remove_spec_char)

review_100$review = sapply(review_100$review, tolower)

#str(review_100[55, ]$review, nchar.max = 100)
```
```{r}
